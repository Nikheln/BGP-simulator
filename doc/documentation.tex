...
\item Modify the received \texttt{UPDATE} message:
	\begin{itemize}
	\item Add own ID to the beginning of \texttt{AS\_PATH}.\footnote{\texttt{NEXT\_HOP} value is changed before serializing the message for each neighbour.}
